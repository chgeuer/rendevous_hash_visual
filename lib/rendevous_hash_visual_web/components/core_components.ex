defmodule RendevousHashVisualWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RendevousHashVisualWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RendevousHashVisualWeb.Gettext, "errors", msg, opts)
    end
  end
